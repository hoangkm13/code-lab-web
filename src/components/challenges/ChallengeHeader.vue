<template>
  <header class="community-header-breadcrumb snipcss-DDJiC">
    <div class="container">
              ...
              <div class="remaining">
                ...
                <span class="current-rank">
                  ...
                  <a class="scoring-link" data-analytics="BadgeLearnMoreLink" data-attr1="java" target="_blank"
                     href="/scoring">
                    <i class="scoring-icon ui-icon-warning-hexagon">
                    </i>
                  </a>
                </div>
              </div>
              <div location="[object Object]" params="[object Object]" router="[object Object]"
                   additionalcontext="[object Object]" class="ui-badge level-silver">
                <div class="ui-badge-wrap">
                  <svg viewBox="0 0 91.66667 100" class="hexagon">
                    <g>
                      <defs>
                        <linearGradient id="badge-silver-gradient" x1="52.5" y1="2.5" x2="52.5" y2="102.5"
                                        gradientUnits="userSpaceOnUse">
                          <stop offset="0" stop-color="#cee3eb">
                          </stop>
                          <stop offset="1" stop-color="#aec8c7">
                          </stop>
                        </linearGradient>
                      </defs>
                    ...
                    <image class="badge-icon"
                           :xlink:href="'https://hrcdn.net/s3_pub/hr-assets/dashboard/' + route.params.link" x="50%"
                           y="22" height="27" width="27" transform="translate(-13.5, 0)">
                    </image>
