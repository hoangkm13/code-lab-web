<template>
  <section class="dashboard-section dashboard-my-tracks">
    ...
    <div class="dashboard-section-grid">
      <div v-for="item in topic" :key="item" class="skill-progress-card card-box">
        ...
        <div class="badge-wrap">
          <div  class="ui-badge level-silver">
            <div class="ui-badge-wrap">
              <svg viewBox="0 0 91.66667 100" class="hexagon has-shadow">
                <g>
                  <defs>
...
let challengeObject = ref([
      {name: "Problem Solving", challengeLink: "https://hrcdn.net/fcore/assets/badges/problem-solving-ecaf59a612.svg"}, {
        name: "Java",
        challengeLink: "https://hrcdn.net/fcore/assets/badges/java-9d05b1f559.svg"
      }
    ]
)
